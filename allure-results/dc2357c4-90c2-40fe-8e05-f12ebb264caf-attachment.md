...
```
Error: locator.click: Unexpected token "" while parsing css selector "input[type='submit]". Did you mean to CSS.escape it?
Call log:
  - waiting for input[type='submit]
          ...
          - group "Your Personal Details" [ref=e80]:
            ...
            - generic [ref=e90]:
              ...
              - textbox "* E-Mail" [ref=e93]:
                - /placeholder: E-Mail
                - text: Carmelo_Kerluke@gmail.com
            - generic [ref=e94]:
              - generic [ref=e95]: "* Telephone"
              - textbox "* Telephone" [ref=e97]:
                - /placeholder: Telephone
                - text: 1-799-735-0079 x352
