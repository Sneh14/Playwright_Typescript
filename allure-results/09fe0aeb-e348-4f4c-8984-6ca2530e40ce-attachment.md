...
```
Error: locator.click: Unexpected token "" while parsing css selector "input[value='Continue]". Did you mean to CSS.escape it?
Call log:
  - waiting for input[value='Continue]
